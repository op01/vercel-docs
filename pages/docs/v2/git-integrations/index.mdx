...
You can change the configuration to Repository Default, `main`, or any other custom branch from the Git Integrations section in your Project Settings page.
