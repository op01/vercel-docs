...
export const meta = {
  ...
  lastEdited: '2020-07-13T16:54:06.000Z'
}
...
A [Production Deployment](/docs/v2/platform/deployments#production) will be created each time you merge to the **Production Branch**. When you create a new Project from a Git repository on <ProductName />, `main` will be the Production Branch. If `main` doesn't exist, the Git repository's default branch will be the Production Branch.

On the **Git Integration** page in the **Project Settings**, you can change your Production Branch to be `main`, the Git repository's default branch or any other custom branch of your choice.
