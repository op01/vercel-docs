...
When you create a new Project from a Git repository on <ProductName />, `main` will be the Production Branch. In the case that `main` doesn't exist, the Git repository's default branch will be the Production Branch.
