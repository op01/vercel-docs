...
A [Production Deployment](/docs/v2/platform/deployments#production) will be created each time you merge to the **Production Branch**. When you connect a new repository to <ProductName />, `main` will be the Production Branch. If `main` doesn't exist, the default branch will be the Production Branch.
