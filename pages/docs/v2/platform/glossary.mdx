...
Production Deployments are a promoted type of Deployment, made available by merging into the [Production Branch](/docs/v2/git-integrations#production-branch) through a Git Integration, or by using the `vercel --prod` command from <ProductShortName /> CLI
