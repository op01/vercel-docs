...
When merging to the [Production Branch](/docs/v2/git-integrations#production-branch) (commonly `master`), a [production deployment](/docs/v2/platform/deployments/#production) will be made.
...
**Production deployments** are made in two different circumstances. Each time you merge to the [Production Branch](/docs/v2/git-integrations#production-branch) (commonly `master`) or make a deployment using the `vercel --prod` command, this is a **production deployment**.
