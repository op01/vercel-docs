...
For projects that were deployed from a Git repository, all you need is to push to the [Production Branch](/docs/v2/git-integrations#production-branch) (usually `master`) and you will get a fresh production deployment.
